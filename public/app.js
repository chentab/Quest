...
(function() {
    ...
    var serverUrl = "/",
        comments = [],
        pusher = new Pusher("ae050920ab8f8041cb47", {
          cluster: 'us2',
          encrypted: true
        }),
    ...
    //commentForm.addEventListener("archive", archiveComment);
    ...
    //   newCommentNode.classList.add('comment');
    //   newCommentNode.innerHTML = newCommentHtml;
    //   archiveList.appendChild(newCommentNode);
    // }
